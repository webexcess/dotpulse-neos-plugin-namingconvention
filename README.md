...
```
composer config repositories.namingconvention vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-namingconvention
```

### Installation
```
composer require dotpulse/namingconvention
```
* * *
> ##### License Terms
